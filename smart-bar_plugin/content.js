var smartbar = (function() {
    ...
    SmartBar.prototype.editModeOn = function editModeOn() {
        this.editMode = true;
        this.storage.local.remove('status');
        this.storage.local.set({'status' : 'On'});
    };

    SmartBar.prototype.editModeOff = function editModeOff() {
        this.editMode = false;
        this.storage.local.remove('status');
        this.storage.local.set({'status' : 'Off'});
    };
...
var sb = window.smartbar.init();

chrome.extension.onMessage.addListener(function (request, sender, sendResponse)
{
    switch (request.type){
        case 'active' : sb.editModeOn(); break;
        case 'nonactive' : sb.editModeOff(); break;
    }
});
