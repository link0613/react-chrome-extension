    ...
    e.fn.pgallery = function(t) {
        var n = {
            ...
            S = function() {
                ...
                h = e('<div class="pgallery-wrapper"></div>');
            ...
            x = function() {
                u = e('<ul class="pgallery-controls"></ul>');
                a = e('<li class="pgallery-next"><a href="#" data-direction="' + g.fwd + '">' + r.nexttext + "</a></li>");
                f = e('<li class="pgallery-prev"><a href="#" data-direction="' + g.prev + '">' + r.prevtext + "</a></li>");
            ...
            T = function() {
                l = e('<ol class="pgallery-markers"></ol>');
            ...
            k = function() {
                e.each(o, function(t, n) {
                    ...
                    if (r) {
                        r = e('<p class="pgallery-caption">' + r + "</p>");
                        r.appendTo(e(n))
                    }
                })
            },
